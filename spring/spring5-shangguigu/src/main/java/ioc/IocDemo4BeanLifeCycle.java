...
import ioc.bean.lifecycle.UserLifeCycle;
 ...
 */
public class IocDemo4BeanLifeCycle {

    @Test
    public void beanLifeCycle() {
        ApplicationContext applicationContext = new ClassPathXmlApplicationContext("ioc/ioc-demo4-bean-life-cycle.xml");
